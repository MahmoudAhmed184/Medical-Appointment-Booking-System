...
const SpecialtyForm = ({ initialData = null, onSubmit, loading = false, onCancel }) => {
    ...
    return (
        <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4">
            {/* Name */}
            <div>
                <label htmlFor="specialty-name" className="block text-sm font-medium text-gray-700 mb-1">
            ...
            {/* Description */}
            <div>
                <label htmlFor="specialty-desc" className="block text-sm font-medium text-gray-700 mb-1">
                    Description
                </label>
                <textarea
                    id="specialty-desc"
            ...
            <div className="flex items-center gap-3 pt-2">
                ...
                {onCancel && (
                    <button
                        type="button"
                        onClick={onCancel}
                        className="px-5 py-2.5 text-sm font-medium rounded-lg border border-gray-200 text-gray-600 hover:bg-gray-50 transition-colors cursor-pointer"
                    >
                        Cancel
                    </button>
                )}
